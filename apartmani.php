...
<body>
        ...
        <div class="container-fluid nav-background">
            <div class="container-md">
                <nav>
                    <a href="home.php"><img src="images/general/logo.png" alt="Drvena kuća Ruža" width="80" height="80"></a>
                ...
                <div class="row mt-5 mb-5 background-lightbrown p-5">
                    <div class="col-lg-6 col-12">
                        <div class="apartman-1">
                            ...
                            <div class="apartman-row">
                                <p><span class="fw-bold">Cena:</span> <?php echo $ap1cena; ?></p>
                            </div>
                            <a href="kontakt.html" class="detaljnije mt-5">REZERVIŠITE</a>
                        </div>
                    </div>
                    <div class="col-lg-6 col-12">
            ...
            <section class="background-lightbrown box-shadow">
                <div class="container-md">
                    <div class="row mt-5 mb-5 background-lightbrown p-5">
                        ...
                        <div class="apartman-row">
                            <p><span class="fw-bold">Cena:</span> <?php echo $ap2cena; ?></p>
                        </div>
                        <a href="kontakt.html" class="detaljnije mt-5">REZERVIŠITE</a>
                ...
                <section class="background-lightbrown box-shadow">
                    <div class="container-md">
                        ...
                        <div class="apartman-row">
                            <p><span class="fw-bold">Cena:</span> <?php echo $ap3cena; ?></p>
                        </div>
                        <a href="kontakt.html" class="detaljnije mt-5">REZERVIŠITE</a>
                                </div>
                            </div>
            ...
            <section class="background-lightbrown box-shadow">
                <div class="container-md">
                    <div class="row mt-5 mb-5 background-lightbrown p-5">
                        ...
                        <div class="apartman-row">
                            <p><span class="fw-bold">Cena:</span> <?php echo $ap4cena; ?></p>
                        </div>
                        <a href="kontakt.html" class="detaljnije mt-5">REZERVIŠITE</a>
                            </div>
                        </div>
